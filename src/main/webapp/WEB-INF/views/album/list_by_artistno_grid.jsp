...
<DIV class='title_line'>
  ...
  <A href="../artist/read.do?artistno=${param.artistno }&now_page=" class='title_link'>${artistVO.name }</A> >
  <A href="./list_by_artistno_grid.do?artistno=${param.artistno }" class='title_link'>앨범</A>
</DIV>

<DIV class='content_body'>
  <ASIDE class="aside_right">
    <A href="./create.do?artistno=${param.artistno }">등록</A>
  ...
  <DIV style="text-align: right; clear: both;">  
    <form name='frm' id='frm' method='get' action='./list_by_artistno_search.do'>
      ...
      <c:if test="${param.word.length() > 0 }">
        <button type='button' 
                     onclick="location.href='./list_by_artistno_search_paging.do?artistno=${artistVO.artistno}&word=&now_page=1'">검색 취소</button>  
      </c:if>    
    </form>
  </DIV>
