...
<DIV class='title_line'>앨범 > 알림</DIV>
    ...
    <UL>
      <c:choose>
        <c:when test="${param.cnt == 1}"> <%-- Java if --%>
          <LI class='li_none'>
            <span class="span_success">앨범 '${param.title }'을 등록했습니다.</span>
          </LI>                                                                      
        </c:when>
        <c:otherwise>
          <LI class='li_none_left'>
            <span class="span_fail">앨범 '${param.title }'등록에 실패했습니다.</span>
          </LI>
          <LI class='li_none_left'>
      ...
      <LI class='li_none'>
        ...
        <c:choose>
          <c:when test="${param.cnt == 1 }">
            ...
            <button type='button' 
                         onclick="location.href='./create.do?artistno=${param.artistno}'"
        ...
        <button type='button' onclick="location.href='./list_by_artistno_grid.do?artistno=${param.artistno}'" class="btn btn-primary">목록</button>
      </LI>
    </UL>
  </fieldset>
