...
<DIV class='content_body'>
  <FORM name='frm' method='POST' action='./create_join.do' class="form-horizontal" 
   ...
   <%--  <input type="hidden" name="artistno" value='${albumVO.artistno }'>
    ...
    <div class="form-group">
       <label class="control-label col-md-4">앨범 번호</label>
       <div class="col-md-8">
         <input type='number' name='albumno' value='' required="required" 
